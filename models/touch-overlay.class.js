...
class TouchOverlay {
    ...
    createButtons() {
        return [
            { id: 'left', relX: 30, relY: -60, width: 50, height: 50, img: new Image(), key: 'LEFT' },
            { id: 'right', relX: 120, relY: -60, width: 50, height: 50, img: new Image(), key: 'RIGHT' },
            { id: 'jump', relX: -90, relY: -60, width: 50, height: 50, img: new Image(), key: 'SPACE' },
            { id: 'shoot', relX: -180, relY: -60, width: 50, height: 50, img: new Image(), key: 'q' },
        ];
    }
     ...
     */
    draw(ctx) {
        if (!this.buttons || this.disabled || !this.isTouchDevice()) return;
