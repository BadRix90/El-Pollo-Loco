class UIManager {
    ...
    drawIntroScreen() {
        ...
        if (this.world.showLyrics
            && this.world.introLyrics[this.world.lyricIndex]) {
            ctx.font = "20px CyberpunkCraftpixPixel";
            ctx.fillStyle = "#ffffff";
            ctx.fillText(
                this.world.introLyrics[this.world.lyricIndex],
                this.canvas.width / 2,
                this.world.introY + 60
            );
        }
        ...
        if (this.world.introStep === 2) {
            ...
            ctx.fillText(
                ...
                this.canvas.width / 2,
                this.world.introY + 110
            );

            this.drawButton(
                this.canvas.width / 2,
                this.world.introY + 150,
                160,
                40,
                "START",
                "start"
